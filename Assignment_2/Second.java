...
public class Employee {
	...
	double salary;
	double SSTax;
	double insuranceCont;
	double byPercent = 3;
	
	public Employee(String name, int age, double salary, double SST, double insuranceCont) {
		this.name = name;
		this.salary = salary;
		this.SSTax = 0;
		this.insuranceCont = 0;
	}
	...
	public static void main(String[] args) {
		Employee employee = new Employee("Charu",26,2000,0,0);
		Employee e1 = new Employee("Arya",9700.50);
		Employee e2 = new Employee("Divya",9500.50);
		Employee e3 = new Employee("Vineet",9800.50);
